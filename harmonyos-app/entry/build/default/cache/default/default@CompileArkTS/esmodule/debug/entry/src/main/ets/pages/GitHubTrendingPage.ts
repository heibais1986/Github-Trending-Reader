...
interface GitHubTrendingPage_Params {
    uiState?: GitHubTrendingUiState;
    viewModel?;
}
import { createGitHubTrendingViewModel, GitHubTrendingUiState } from "@bundle:com.github.trending/entry/ets/viewmodels/index";
import type { Repository } from '../models/Repository';
export class GitHubTrendingPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
        }
        this.__uiState = new ObservedPropertyObjectPU(new GitHubTrendingUiState(), this, "uiState");
        this.viewModel = createGitHubTrendingViewModel();
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }
    setInitiallyProvidedValue(params: GitHubTrendingPage_Params) {
    ...
    updateStateVars(params: GitHubTrendingPage_Params) {
    }
    ...
    private __uiState: ObservedPropertyObjectPU<GitHubTrendingUiState>;
    get uiState() {
        return this.__uiState.get();
    }
    set uiState(newValue: GitHubTrendingUiState) {
        this.__uiState.set(newValue);
    }
    private viewModel;
    aboutToAppear() {
        // 监听ViewModel状态变化
        this.viewModel.addStateChangeListener((state: GitHubTrendingUiState) => {
